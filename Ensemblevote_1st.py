...
#clf5 = ExtraTreesClassifier(n_estimators=160,max_leaf_nodes=40)

eclf1 = EnsembleVoteClassifier(clfs=[clf1, clf2, clf3, clf4], weights=[4, 1, 1,0.5], voting='soft')

eclf1 = eclf1.fit(X_train, list(y_train))
