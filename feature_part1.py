...
# 				# 	X_train[e][5] = merchant_number_of_brand[train_ids_merchant[row[0]]]
# 				# else:
# 				# 	X_train[e][5] = 0
# 				# if train_ids_merchant[row[0]] in merchant_number_of_cat:
# 				# 	X_train[e][6] = merchant_number_of_cat[train_ids_merchant[row[0]]]
# 				# else:
# 				# 	X_train[e][6] = 0
# 				# if train_ids_merchant[row[0]] in merchant_number_of_brand:
# 				# 	X_train[e][7] = merchant_number_of_item[train_ids_merchant[row[0]]]
# 				# else:
# 				# 	X_train[e][7] = 0
# 				# if train_ids_merchant[row[0]] in merchant_deals_times:
# 				# 	X_train[e][8] = merchant_deals_times[train_ids_merchant[row[0]]]
# 				# else:
# 				# 	X_train[e][8] = 0
# 				# if train_ids_merchant[row[0]] in merchant_favo_times:
# 				# 	X_train[e][9] = merchant_favo_times[train_ids_merchant[row[0]]]
# 				# else:
# 				# 	X_train[e][9] = 0
# 				# if train_ids_merchant[row[0]] in merchant_deals_times_in_1111:
# 				# 	X_train[e][10] = merchant_deals_times_in_1111[train_ids_merchant[row[0]]]
# 				# else:
# 				# 	X_train[e][10] = 0
# 				# print X_train[e]
				if e % 1000 == 0:
	...
	#print merchant_deals_times
				...
				# 	X_test[e][5] = merchant_number_of_brand[test_ids_merchant[row[0]]]
				# else:
				# 	X_test[e][5] = 0
				# if test_ids_merchant[row[0]] in merchant_number_of_cat:
				# 	X_test[e][6] = merchant_number_of_cat[test_ids_merchant[row[0]]]
				# else:
				# 	X_test[e][6] = 0
				# if test_ids_merchant[row[0]] in merchant_number_of_brand:
				# 	X_test[e][7] = merchant_number_of_item[test_ids_merchant[row[0]]]
				# else:
				# 	X_test[e][7] = 0
				# if test_ids_merchant[row[0]] in merchant_deals_times:
				# 	X_test[e][8] = merchant_deals_times[test_ids_merchant[row[0]]]
				# else:
				# 	X_test[e][8] = 0
				# if test_ids_merchant[row[0]] in merchant_favo_times:
				# 	X_test[e][9] = merchant_favo_times[test_ids_merchant[row[0]]]
				# else:
				# 	X_test[e][9] = 0
				# # if test_ids_merchant[row[0]] in merchant_deals_times_in_1111:
				# 	X_test[e][10] = merchant_deals_times_in_1111[test_ids_merchant[row[0]]]
				# else:
				# 	X_test[e][10] = 0
				# print X_test[e]
...
if __name__ == '__main__':
	...
	np.savetxt("X_train_newfeature_part1.csv", X_train,fmt='%10.3f', delimiter=",")
	np.savetxt("X_test_newfeature_part1.csv", X_test, fmt='%10.3f',delimiter=",")
